...
// Commented out as `updateProduct` is not being used
...
// Commented out as `fetchProductYouMayAlsoLike` is not being used
...
export const productSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder
      ...
      // Commented out as `updateProductAsync` is not being used
      ...
      // Commented out as `fetchProductYouMayAlsoLikeAsync` is not being used
